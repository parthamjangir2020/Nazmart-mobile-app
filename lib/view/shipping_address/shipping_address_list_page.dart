...
class ShippingAddressListPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: appbarCommon('Shipping address', context, () {
        Navigator.pop(context);
      }),
      body: SingleChildScrollView(
        child: Consumer<ShippingListService>(
          builder: (context, provider, child) => provider.isloading == false
              ? provider.addressList.isNotEmpty
                  ...
                  : nothingfound(context, 'You don\'t have any address saved')
              : Container(
      ...
      bottomNavigationBar: Container(
        ...
        child: buttonPrimary('Add/Replace Address', () {
